<head>
        ...
        <!--/fonts-->
        <script type="text/javascript" src="/views/scripts/move-top.js"></script>
        <script type="text/javascript" src="/views/scripts/easing.js"></script>
        ...
        <script type="text/javascript" src="/views/scripts/megamenu.js"></script>
        <script>$(document).ready(function () {
        $(".megamenu").megamenu();
    });</script>
   
        <script type="text/javascript" src="/views/scripts/myJavaScript.js"></script>
        <!--<script src="/views/scripts/simpleCart.min.js"></script>-->
